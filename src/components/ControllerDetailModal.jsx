      ...
      <div onClick={e => e.stopPropagation()} className="bg-white rounded-lg shadow-lg p-6 w-[600px]">
        ...
        <form onSubmit={(e) => handleForm(e)} className="flex flex-col gap-2">
          ...
          <div className="flex items-center gap-4">
            <button type="submit" className="bg-black text-white px-4 py-2 rounded">추가</button>
            <button type="button" onClick={onClose} className="bg-blue-500 text-white px-4 py-2 rounded">
              닫기
            </button>
          </div>
        </form>
